<div>
    ...
    @if ($mostrarFormulario)
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 mb-8">
            <form wire:submit.prevent="save">
                ...
                <x-label class="mb-4 block font-semibold text-sm text-gray-800 dark:text-gray-200 leading-tight"> Seleccione el tipo de movimiento</x-label>
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            <ul class="list-disc list-inside space-y-2">
                @foreach ($movimientos as $movimiento)
                    <li class="font-semibold text-sm dark:text-gray-200 leading-tight mb-3 flex justify-between"
                        wire:key="movimiento--{{ $movimiento->id }}">
                        {{ $movimiento->motivo }}
                        <div>
    ...
    <x-dialog-modal wire:model="openModalAgregarInsumo">
        ...
        <x-slot name="footer">
            <x-danger-button class="mr-2" type="button" wire:click="$toggle('openModalAgregarInsumo')">Cancelar</x-danger-button>
    ...
    <x-dialog-modal wire:model="openModalEditarInsumo">
        ...
        <x-slot name="footer">
            <x-danger-button class="mr-2" type="button" wire:click="$toggle('openModalEditarInsumo')">Cancelar</x-danger-button>
