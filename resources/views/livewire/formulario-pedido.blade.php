                ...
                <div>                                       
                    <li class="font-semibold text-sm dark:text-gray-200 leading-tight mb-3 flex justify-between" 
                        ...
                        <div>                                                        
                            ...
                            <x-button type="button" wire:click="$set('openModalArquitectura', true)">Arquitectura</x-button>                            
                            <x-button type="button" wire:click="$set('openModalBastidor', true)">Bastidor</x-button>                            
                            <x-button type="button" wire:click="$set('openModalAcondicionamiento', true)">Acondicionamiento</x-button>                                                        
            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                ...
                <li class="font-semibold text-sm dark:text-gray-200 leading-tight mb-3 flex justify-between"
                    ...
                    <div>
                        ...
                        <x-danger-button type="button" wire:click="deleteModal({{ $index }})">Eliminar</x-danger-button>                                                
                    </div>
                </li>
                @endforeach
            ...
            <ul class="list-disc list-inside space-y-2">
                @foreach ($pedidos as $pedido)
                    <li class="font-semibold text-sm dark:text-gray-200 leading-tight mb-3 flex justify-between"
                        ...
                        {{ $pedido->descripciongeneral }}
                        {{ $pedido->estado }}                        
                        <div>
                            @if ($pedido->estado == 'Cotizado')
                            @can('Ver cotizacion recibida')                            
                            <x-button wire:click="verCotizacion({{ $pedido->id }})">Ver Cotizacion del Pedido</x-button>
                            @endcan
                            @endif
                            @can('Solicitar una cotizacion para un pedido')                            
                                <x-button wire:click="detallePedidoFromFront({{ $pedido->id }})">Ver Detalle del Pedido</x-button>
                            @endcan
