       ...
       <ul class="space-y-2 font-medium">
          ...
          <li>
            ...
            <ul id="dropdown-example1" class="hidden py-2 space-y-2">                  
                  ...
                  @can('Visualizar pestaña de Gestion de Medicos')
                  <li>
                     <a href="{{ route('formulario.medicos')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Gestion de Medicos</a>
                  </li>
                  @endcan
                  @can('Visualizar pestaña de Gestion de Pacientes')
                  <li>
                     <a href="{{ route('formulario.pacientes')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Gestion de Pacientes</a>
                  </li>
                  @endcan
                  @can('Visualizar pestaña de Gestion de Recepcionistas')
                  <li>
                     <a href="{{ route('formulario.recepcionistas')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Gestion de Recepcionistas</a>
                  </li>                  
                  @endcan
         ...
         <li>
            ...
            <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example7" data-collapse-toggle="dropdown-example7">
                  ...
                  <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Atencion Medica</span>
                  <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                     <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                  </svg>
            </button>
            ...
            <ul id="dropdown-example7" class="hidden py-2 space-y-2">
               @can('Ver pestaña de Especialidades') 
               <li>
                   <a href="{{ route('formulario.especialidades')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Especialidades</a>
                </li>
                @endcan                                
                @can('Ver pestaña de Salas') 
               <li>
                   <a href="{{ route('formulario.salas')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Salas</a>
                </li>
                @endcan               
                @can('Ver pestaña de asignacion de especialidades medicas') 
               <li>
                   <a href="{{ route('formulario.medico.especialidad')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Asignacion de Especialidades medicas</a>
                </li>
                @endcan                
                @can('Ver pestaña de turnos de atencion') 
               <li>
                   <a href="{{ route('formulario.turno.atencion')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Asignacion de Turnos de Atencion</a>
                </li>
                @endcan                
         ...
         <li>
            @can('Visualizar pestaña de Consulta Medica')
            <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example8" data-collapse-toggle="dropdown-example8">
                  ...
                  <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Consulta Medica</span>
                  <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                     <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                  </svg>
            </button>
         ...
         <li>
            ...
            <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example9" data-collapse-toggle="dropdown-example9">
                  ...
                  <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Consultas Realizadas</span>
                  <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                     <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                  </svg>
            </button>
